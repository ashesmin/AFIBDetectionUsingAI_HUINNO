...
%function [Data] = f_filterbpf(Data, fc, order, phase)
...
function [Data] = fFilterLPF(Data, fc, order, FILTTYPE, PHASE)
% fc 		: 	filter cutoff frequency (normalized by fs/2)
% order 	:	filter order
